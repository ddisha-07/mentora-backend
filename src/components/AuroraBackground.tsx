    ...
    >
      <style>{`
        ...
        @keyframes aurora-drift-1 {
          ...
          33% { transform: translate3d(8vw, 12vh, 0) scale(1.1) rotate(120deg); }
          66% { transform: translate3d(-5vw, 6vh, 0) scale(0.9) rotate(240deg); }
          100% { transform: translate3d(0, 0, 0) scale(1) rotate(360deg); }
        }
        @keyframes aurora-drift-2 {
          0% { transform: translate3d(0, 0, 0) scale(1) rotate(0deg); }
          50% { transform: translate3d(-10vw, -8vh, 0) scale(0.95) rotate(-180deg); }
          100% { transform: translate3d(0, 0, 0) scale(1) rotate(-360deg); }
        }
        @keyframes aurora-drift-3 {
          0% { transform: translate3d(0, 0, 0) scale(1) rotate(0deg); }
          50% { transform: translate3d(12vw, -5vh, 0) scale(1.08) rotate(180deg); }
          100% { transform: translate3d(0, 0, 0) scale(1) rotate(360deg); }
        }
        @keyframes aurora-drift-4 {
          0% { transform: translate3d(0, 0, 0) scale(1) rotate(0deg); }
          50% { transform: translate3d(-12vw, 10vh, 0) scale(1.03) rotate(180deg); }
          100% { transform: translate3d(0, 0, 0) scale(1) rotate(360deg); }
        }
        @keyframes aurora-drift-5 {
          0% { transform: translate3d(0, 0, 0) scale(1) rotate(0deg); }
          33% { transform: translate3d(-8vw, -12vh, 0) scale(1.05) rotate(-120deg); }
          66% { transform: translate3d(10vw, -8vh, 0) scale(0.95) rotate(-240deg); }
          100% { transform: translate3d(0, 0, 0) scale(1) rotate(-360deg); }
        }
        @keyframes aurora-drift-6 {
          0% { transform: translate3d(0, 0, 0) scale(1) rotate(0deg); }
          50% { transform: translate3d(10vw, 8vh, 0) scale(1.08) rotate(180deg); }
          100% { transform: translate3d(0, 0, 0) scale(1) rotate(360deg); }
        }
        @keyframes aurora-drift-7 {
          0% { transform: translate3d(0, 0, 0) scale(1) rotate(0deg); }
          50% { transform: translate3d(-8vw, 12vh, 0) scale(0.92) rotate(-180deg); }
          100% { transform: translate3d(0, 0, 0) scale(1) rotate(-360deg); }
        }
        @keyframes aurora-drift-8 {
          0% { transform: translate3d(0, 0, 0) scale(1) rotate(0deg); }
          50% { transform: translate3d(5vw, -10vh, 0) scale(1.1) rotate(180deg); }
          100% { transform: translate3d(0, 0, 0) scale(1) rotate(360deg); }
        }
